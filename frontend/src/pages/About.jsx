      ...
      <div className="max-w-[1280px] mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row text-sm mb-20">
          <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
            ...
            <p className="text-gray-600 futura">{t('about.whyChooseUs.quality.description')}</p>
          </div>
          <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
            <b className="flex items-center gap-2">
              <FaThumbsUp /> {t('about.whyChooseUs.convenience.title')}
            </b>
            <p className="text-gray-600 futura">{t('about.whyChooseUs.convenience.description')}</p>
          </div>
          <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
            <b className="flex items-center gap-2">
              <FaInfoCircle /> {t('about.whyChooseUs.service.title')}
            </b>
            <p className="text-gray-600 futura">{t('about.whyChooseUs.service.description')}</p>
          </div>
        </div>
      </div>
      <NewsletterBox />
